...
class ApiConstants {
  ...
  static const String settingsBlockedKeywords =
      '/settings/{childId}/blocked-keywords';
  static const String settingsNotificationFilters =
      '/settings/{childId}/notification-filters';
  ...
  static const String cameraStream =
      '/camera/child/{childId}/{captureId}/stream';
