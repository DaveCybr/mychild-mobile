...
class _ApiClient implements ApiClient {
  _ApiClient(
    ...
    baseUrl ??= 'https://parentalcontrol.satelliteorbit.cloud/api';
  }
  ...
  Future<ApiResponse<FamilyModel>> createFamily(
    ...
    final _options = _setStreamType<ApiResponse<FamilyModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ApiResponse<List<UserModel>>> getFamilyMembers() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<UserModel>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ApiResponse<List<Map<String, dynamic>>>> getLocationHistory(
    ...
    const Map<String, dynamic>? _data = null;
    final _options =
        _setStreamType<ApiResponse<List<Map<String, dynamic>>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
